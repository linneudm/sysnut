# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2018-01-21 14:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('original_food', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='meal_food', to='food.Food', verbose_name='Alimento')),
            ],
        ),
        migrations.CreateModel(
            name='UploadSheet',
