...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('meal', models.CharField(blank=True, choices=[('CAFÉ DA MANHÃ', 'Café da Manhã'), ('LANCHE I', 'Lanche I'), ('ALMOÇO', 'Almoço'), ('LANCHE II', 'Lanche II'), ('JANTAR', 'Jantar'), ('CEIA', 'Ceia')], default=None, max_length=40, null=True, verbose_name='Refeição')),
                ('home_measure', models.CharField(max_length=255, verbose_name='Med. Caseira')),
                ('weight', models.DecimalField(decimal_places=2, default=100.0, max_digits=8, verbose_name='Peso líquido (ml ou g)')),
            ],
        ),
        migrations.CreateModel(
