    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('family_history', models.CharField(blank=True, max_length=255, null=True, verbose_name='Histórico Familiar')),
        ...
        migrations.AddField(
            model_name='consultation',
            name='vitamin',
            field=models.ManyToManyField(blank=True, null=True, related_name='consultation_vitamin', to='patient.Vitamin', verbose_name='Deficiência Vitamínica'),
        ),
        migrations.AddField(
