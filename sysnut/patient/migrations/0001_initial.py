# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2017-12-05 00:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wrist_diameter', models.DecimalField(decimal_places=2, default=0.0, max_digits=8, verbose_name='Diâmetro do úmero (cm)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('trans_fat', models.BooleanField(verbose_name='Alimentos com alto teor de Gorduras Trans')),
                ('antioxidant', models.BooleanField(verbose_name='Alimentos com alto teor de Vitaminas Antioxidantes')),
                ('sodium', models.BooleanField(verbose_name='Alimentos com alto teor de Sódio')),
                ('potassium', models.BooleanField(verbose_name='Alimentos com alto teor de Potássio')),
                ('phosphor', models.BooleanField(verbose_name='Alimentos com alto teor de Fósforo')),
                ('fiber', models.BooleanField(verbose_name='Alimentos com alto teor de Fibras')),
                ('iron', models.BooleanField(verbose_name='Alimentos com alto teor de Ferro')),
                ('sulfur', models.BooleanField(verbose_name='Alimentos com alto teor de Enxofre')),
                ('cholesterol', models.BooleanField(verbose_name='Alimentos com alto teor de Colesterol')),
                ('calcium', models.BooleanField(verbose_name='Alimentos com alto teor de Cálcio')),
                ('ac_oxalic', models.BooleanField(verbose_name='Alimentos com alto teor de Ácido Oxálico')),
                ('ac_folic', models.BooleanField(verbose_name='Alimentos com alto teor de Ácido Fólico')),
                ('obstipating', models.BooleanField(verbose_name='Alimentos obstipantes')),
                ('laxative', models.BooleanField(verbose_name='Alimentos laxativos')),
                ('functional', models.BooleanField(verbose_name='Alimentos funcionais')),
                ('flatulent', models.BooleanField(verbose_name='Alimentos flatulentos')),
                ('peptic_ulcer', models.BooleanField(verbose_name='Orientação para Úlcera Péptica')),
                ('chronic_pancreatitis', models.BooleanField(verbose_name='Orientação para Pancreatite Crônica')),
                ('osteoporosis', models.BooleanField(verbose_name='Orientação para Osteoropose')),
                ('constipation', models.BooleanField(verbose_name='Orientação para Obstipação')),
                ('megaesuffer', models.BooleanField(verbose_name='Orientação para Megaesôfogo')),
                ('parkinson', models.BooleanField(verbose_name='Orientação para Mal de Parkinson')),
                ('renal_insufficiency_chronic', models.BooleanField(verbose_name='Orientação para Insuficiência Renal Crônica')),
                ('lactose_intolerance', models.BooleanField(verbose_name='Orientação para Intolerância a Lactose')),
                ('hypertriglyceridemia', models.BooleanField(verbose_name='Orientação para Hipertrigliceridemia')),
                ('hypertension', models.BooleanField(verbose_name='Orientação para Hipertensão')),
                ('chronic_hepatitis', models.BooleanField(verbose_name='Orientação para Hepatite Crônica')),
                ('gout', models.BooleanField(verbose_name='Orientação para Gota')),
                ('chronic_gastritis', models.BooleanField(verbose_name='Orientação para Gastrite Crônica')),
                ('epilepsy', models.BooleanField(verbose_name='Orientação para Epilepsia')),
                ('intestinal_inflammation', models.BooleanField(verbose_name='Orientação para doenças Inflamatórias Intestinais')),
                ('diarrhea', models.BooleanField(verbose_name='Orientação para Diarreia')),
                ('abreviation_list', models.BooleanField(verbose_name='Lista de Abreviações')),
                ('analysis', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='guidance_analysis', to='patient.FoodAnalysis', verbose_name='Cardápio')),
            ],
        ),
        migrations.CreateModel(
            name='Patient',
