    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bone_diameter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='consultation_bone_diameter', to='patient.BoneDiameter', verbose_name='Diâmetro ósseo')),
            ],
            options={
